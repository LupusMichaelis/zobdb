...
void zob_config_vector_find(struct zob_config ** pp, size_t position, struct zob_string * p_value);
void zob_config_vector_get(struct zob_config ** pp, size_t position, struct zob_string ** pp_value);
void zob_config_vector_get_by_name(struct zob_config ** pp_config
